...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "DEFAULT_API_URL", "\"${localProperties.getProperty("API_URL", "http://10.0.2.2:20808")}\"")
    }
    ...
    applicationVariants.configureEach {
        outputs.configureEach {
            ...
            outputImpl.outputFileName = "ntfy-mgr-${buildType.name}-$version.apk"
        }
    }
}
