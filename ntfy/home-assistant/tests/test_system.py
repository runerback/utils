...
if __name__ == "__main__":
    test_cpu_temp_returns_none_when_no_thermal()
    test_memory_usage_handles_missing_proc_meminfo()
    test_memory_usage_parses_sample_meminfo()
    print("OK: system metrics helpers")
