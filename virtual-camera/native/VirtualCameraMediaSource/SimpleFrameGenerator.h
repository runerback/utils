...
public:
    ...
    HRESULT Initialize(_In_ IMFMediaType* pMediaType, _In_opt_z_ LPCWSTR imagePath);
...
private: 
    HRESULT _LoadImageFrame(_In_z_ LPCWSTR imagePath);
    HRESULT _CopyLoadedRGB32Frame(
        _Inout_updates_bytes_(len) BYTE* pBuf,
        _In_ DWORD len,
        _In_ LONG pitch,
        _In_ DWORD width,
    ...
    std::vector<BYTE> m_loadedRGB32Frame;
