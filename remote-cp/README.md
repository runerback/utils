...
- Total upload payloads are capped at 100 MB per request.
- Video uploads support `.mp4` and appear inline in the room with muted autoplay and playback controls.
- General file uploads are limited to document-style formats: `.7z`, `.csv`, `.doc`, `.docx`, `.json`, `.md`, `.pdf`, `.ppt`, `.pptx`, `.rtf`, `.txt`, `.xls`, `.xlsx`, and `.zip`.
